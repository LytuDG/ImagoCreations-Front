...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, RouterModule, AppFloatingConfigurator, ButtonModule, TranslocoModule],
    template: `
                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, color-mix(in srgb, var(--primary-color), transparent 60%) 10%, var(--surface-ground) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                        ...
                        <div class="text-surface-600 dark:text-surface-200 mb-8">
                            {{ 'notFound.description' | transloco }}
                        </div>
                        ...
                        <a routerLink="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                            ...
                            <span class="ml-6 flex flex-col">
                                <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0 block">
                                    {{ 'notFound.links.faq.title' | transloco }}
                                </span>
                                <span class="text-surface-600 dark:text-surface-200 lg:text-xl">
                                    {{ 'notFound.links.faq.description' | transloco }}
                                </span>
                            </span>
                        </a>
                        ...
                        <a routerLink="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                            ...
                            <span class="ml-6 flex flex-col">
                                <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">
                                    {{ 'notFound.links.support.title' | transloco }}
                                </span>
                                <span class="text-surface-600 dark:text-surface-200 lg:text-xl">
                                    {{ 'notFound.links.support.description' | transloco }}
                                </span>
                            </span>
                        </a>
                        ...
                        <a routerLink="/" class="w-full flex items-center mb-8 py-8 border-surface-300 dark:border-surface-500 border-b">
                            ...
                            <span class="ml-6 flex flex-col">
                                <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">
                                    {{ 'notFound.links.home.title' | transloco }}
                                </span>
                                <span class="text-surface-600 dark:text-surface-200 lg:text-xl">
                                    {{ 'notFound.links.home.description' | transloco }}
                                </span>
                            </span>
                        </a>

                        <p-button
                            [label]="'notFound.button' | transloco"
                            routerLink="/"
...
export class Notfound implements OnInit {
    ...
    ngOnInit() {
        const title = this.translocoService.translate('notFound.seo.title');
        const description = this.translocoService.translate('notFound.seo.description');
