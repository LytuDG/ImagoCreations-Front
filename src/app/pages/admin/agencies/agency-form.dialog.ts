...
@Component({
    ...
    template: `
        <p-dialog [(visible)]="visible" [style]="{ width: '600px' }" header="{{ isEditMode ? 'Editar Agencia' : 'Nueva Agencia' }}" [modal]="true" (onHide)="onCancel()">
            <ng-template #content>
                    ...
                    <div class="border-round border-1 surface-border p-4">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="text" pInputText id="agencyName" [(ngModel)]="agencyForm.name" required class="w-full" placeholder="Ingrese el nombre de la agencia" />
                            ...
                            <div>
                                ...
                                <input type="email" pInputText id="agencyEmail" [(ngModel)]="agencyForm.email" required class="w-full" placeholder="email@agencia.com" />
                            ...
                            <div>
                                ...
                                <textarea pInputText id="agencyAddress" [(ngModel)]="agencyForm.address" required class="w-full" rows="3" placeholder="Dirección completa de la agencia"></textarea>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input type="text" pInputText id="agencyPhoneCode" [(ngModel)]="agencyForm.phoneCountryCode" class="w-full" placeholder="57" maxlength="3" />
                                </div>
                                <div>
                                    <label for="agencyPhone" class="block font-bold mb-2">Teléfono</label>
                                    <input type="text" pInputText id="agencyPhone" [(ngModel)]="agencyForm.phone" class="w-full" placeholder="Número telefónico" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input type="text" pInputText id="adminName" [(ngModel)]="agencyForm.user!.name" required class="w-full" placeholder="Nombre del administrador" />
                                    ...
                                    <div>
                                        ...
                                        <input type="text" pInputText id="adminLastName" [(ngModel)]="agencyForm.user!.lastName" class="w-full" placeholder="Apellido del administrador" />
                                    </div>
                                </div>

                                <div>
                                    <label for="adminEmail" class="block font-bold mb-2">Email *</label>
                                    <input type="email" pInputText id="adminEmail" [(ngModel)]="agencyForm.user!.email" required class="w-full" placeholder="admin@email.com" />
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <p-password id="adminPassword" [(ngModel)]="agencyForm.user!.password" [toggleMask]="true" [feedback]="false" class="w-full" placeholder="Contraseña del administrador" />
                                    ...
                                    <div>
                                        <label for="adminPasswordConfirm" class="block font-bold mb-2">Confirmar Contraseña *</label>
                                        <p-password id="adminPasswordConfirm" [(ngModel)]="agencyForm.user!.passwordConfirm" [toggleMask]="true" [feedback]="false" class="w-full" placeholder="Confirmar contraseña" />
                                        @if (submitted && !agencyForm.user!.passwordConfirm) {
                                            <small class="text-red-500 block">La confirmación de contraseña es requerida</small>
                                        }
                                        @if (submitted && agencyForm.user!.password && agencyForm.user!.passwordConfirm && agencyForm.user!.password !== agencyForm.user!.passwordConfirm) {
                                            <small class="text-red-500 block">Las contraseñas no coinciden</small>
                                        }
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input type="text" pInputText id="adminPhoneCode" [(ngModel)]="agencyForm.user!.phoneCountryCode" class="w-full" placeholder="57" maxlength="3" />
                                    </div>
                                    <div>
                                        <label for="adminPhone" class="block font-bold mb-2">Teléfono</label>
                                        <input type="text" pInputText id="adminPhone" [(ngModel)]="agencyForm.user!.phone" class="w-full" placeholder="Número telefónico" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
export class AgencyFormComponent {
    ...
    onSave() {
        ...
        if (this.isEditMode) {
            ...
            if (!this.agencyForm.name || !this.agencyForm.email || !this.agencyForm.address || !this.agencyForm.user!.name || !this.agencyForm.user!.email || !this.agencyForm.user!.password) {
                return;
            }
        }
